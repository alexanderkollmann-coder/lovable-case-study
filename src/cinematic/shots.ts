...
export const SHOTS: Shot[] = [
  ...
  },
  {
    ...
    description: 'Frontal Big Ben + Eye dolly-back. Trimmed: skips the first 2s and last 0.5s of the original 6s motion.',
    duration: 3.5,
    timeline: 'pre',
    filename: 'tour-02-london',
    keys: [
      { t: 0.0, pos: [-17, 5.06, 6.67],  lookAt: [-17, 3.78, -11.56], zoom: 78 },
      { t: 1.0, pos: [-17, 6.97, 15.83], lookAt: [-17, 3.01, -10.03], zoom: 36.75 },
    ],
  },
  {
    id: 'tour-hack',
    name: 'Tour · Hackathon orbit + winner push-in (with hold)',
    description: 'Slow side-arc around the hack arena, push in to the winner podium, then hold ~1.1s. Orbit motion preserved; winner hold shortened by 1s.',
    duration: 6,
    timeline: 'hack',
    filename: 'tour-03-hack',
    keys: [
      { t: 0.000, pos: [-10, 6, 9],     lookAt: [0, 1, 0],         zoom: 36  },
      { t: 0.525, pos: [9, 4, 6],       lookAt: [3, 1, -2],        zoom: 50  },
      { t: 0.817, pos: [4.6, 1.6, -5.0], lookAt: [6.5, 0.6, -6.3], zoom: 130 },
      { t: 1.000, pos: [4.6, 1.6, -5.0], lookAt: [6.5, 0.6, -6.3], zoom: 130 }, // hold ~1.1s
    ],
  },
  {
    id: 'tour-post',
    name: 'Tour · Post-hack diagonal orbit',
    description: 'Diagonal sweep across the command centre. Trimmed: skips the first 2s and last 1s of the original 5s motion.',
    duration: 2,
    timeline: 'post',
    filename: 'tour-04-post',
    keys: [
      { t: 0.00, pos: [17.64, 7.84, 11.68], lookAt: [17, 2.18, -5.84], zoom: 38 },
      { t: 0.25, pos: [17, 8, 12],          lookAt: [17, 2.2, -6],     zoom: 38 },
      { t: 1.00, pos: [11.56, 6.64, 9.28],  lookAt: [17, 2.06, -4.64], zoom: 38 },
    ],
  },
  {
    id: 'tour-topdown',
